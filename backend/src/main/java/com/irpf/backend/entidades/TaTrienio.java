...
/**
 * Entidad JPA que representa la tabla y los datos de dominio de TaTrienio.
 */
@Entity
@Table(name = "ta_trienio")
@IdClass(AnioEstudioId.class)
public class TaTrienio {
    ...
    public TaTrienio(Integer anio, String codEstudio, BigDecimal importe) {
        this.anio = anio;
