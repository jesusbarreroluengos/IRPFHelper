...
/**
 * Entidad JPA que representa la tabla y los datos de dominio de TaDestino.
 */
@Entity
@Table(name = "ta_destino")
@IdClass(AnioEstudioId.class)
public class TaDestino {
    ...
    public TaDestino(Integer anio, String codEstudio, BigDecimal importe) {
        this.anio = anio;
