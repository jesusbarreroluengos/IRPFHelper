...
/**
 * Entidad JPA que representa la tabla y los datos de dominio de TaSueldo.
 */
@Entity
@Table(name = "ta_sueldo")
@IdClass(AnioEstudioId.class)
public class TaSueldo {
    ...
    public TaSueldo(Integer anio, String codEstudio, BigDecimal importe) {
        this.anio = anio;
