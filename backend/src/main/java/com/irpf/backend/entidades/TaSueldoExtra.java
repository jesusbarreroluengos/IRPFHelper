...
/**
 * Entidad JPA que representa la tabla y los datos de dominio de TaSueldoExtra.
 */
@Entity
@Table(name = "ta_sueldo_extra")
@IdClass(AnioEstudioId.class)
public class TaSueldoExtra {
    ...
    public TaSueldoExtra() {
    }

    public TaSueldoExtra(Integer anio, String codEstudio, BigDecimal importe) {
        this.anio = anio;
