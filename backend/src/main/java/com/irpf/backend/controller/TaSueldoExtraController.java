...
/**
 * Controlador REST para el mantenimiento de la tabla ta_sueldo_extra.
 */
@RestController
@RequestMapping("/api/admin/sueldo-extra")
public class TaSueldoExtraController {

    @Autowired
    private TaSueldoExtraRepository repository;

    @GetMapping("/all")
    public List<TaSueldoExtra> getAll() {
        return repository.findAll();
    }

    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody TaSueldoExtra entity) {
