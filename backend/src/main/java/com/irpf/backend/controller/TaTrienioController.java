...
/**
 * Controlador REST para el mantenimiento de la tabla ta_trienio.
 */
@RestController
@RequestMapping("/api/admin/trienio")
@CrossOrigin(origins = "http://localhost:4200", allowCredentials = "true")
public class TaTrienioController {

    @Autowired
    private TaTrienioRepository repository;

    @GetMapping("/all")
    public List<TaTrienio> getAll() {
        return repository.findAll();
    }

    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody TaTrienio entity) {
