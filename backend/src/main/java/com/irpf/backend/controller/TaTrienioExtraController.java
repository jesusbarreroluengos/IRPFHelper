...
/**
 * Controlador REST para el mantenimiento de la tabla ta_trienio_extra.
 */
@RestController
...
public class TaTrienioExtraController {
    ...
    @Autowired
    private TaTrienioExtraRepository repository;

    @GetMapping("/all")
    public List<TaTrienioExtra> getAll() {
        return repository.findAll();
    }

    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody TaTrienioExtra entity) {
